...
unset($__errorArgs, $__bag); ?>" name="url" value="<?php echo e($steadfast->url); ?>" id="url" required="" readonly />
                <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/softitbd/fcom4/resources/views/backEnd/apiintegration/courier_manage.blade.php ENDPATH**/ ?>