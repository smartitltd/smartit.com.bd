    ...
    <div id="wrapper">
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end">&copy; <?php echo e($generalsetting->name); ?> <a href="https://soft-itbd.com" target="_blank">SOFT-ITBD</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH /home/softitbd/fcom4/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>